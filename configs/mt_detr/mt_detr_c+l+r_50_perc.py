...
model = dict(
    backbone=dict(
        ...
        net2='ConvNeXt',
        net3='ConvNeXt',
        net4='ResidualFusionModule',
        net5='ConfidenceFusionModule',
        net6='EnhancementModule',
        net7='EnhancementModule',
        net8='EnhancementModule',
        args1=dict(
            in_chans=3,
            depths=[3, 3, 27, 3], 
...
train_pipeline = [
    dict(type='LoadImageFromMultiFile'),
...
data = dict(
    ...
    train=dict(
        ...
        classes=classes,
        ann_file="data/coco_annotation/new_additional_50_perc_split/train_all_simple_50_perc.json",
        pipeline=train_pipeline,
        ),
    val=dict(
        img_prefix=prefix_list,
        classes=classes,
        ann_file="data/coco_annotation/new_additional_50_perc_split/val_all_simple_50_perc.json",
        pipeline=test_pipeline,
        ),
    test=dict(
        img_prefix=prefix_list,
        classes=classes,
        ann_file="data/coco_annotation/new_split_50_perc_train_raw/test_clear_simple.json",
        pipeline=test_pipeline,
        ),
    )
