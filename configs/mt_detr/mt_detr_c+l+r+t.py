...
model = dict(
    backbone=dict(
        ...
        bb3='ConvNeXt',
        bb4='ConvNeXt',
        fu1='ResidualFusionModule',
        fu2='ConfidenceFusionModule',
        sca1='EnhancementModule',
        sca2='EnhancementModule',
        sca3='EnhancementModule',
        sca4='EnhancementModule',
        args_bb1=dict(
            in_chans=3,
            depths=[3, 3, 27, 3], 
...
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53, 123.675, 116.28, 103.53,123.675, 116.28, 103.53, 128.0, 128.0, 128.0]
    ,std=[58.395, 57.12, 57.375, 58.395, 57.12, 57.375, 58.395, 57.12, 57.375, 60.0, 60.0, 60.0], to_rgb=False)

train_pipeline = [
    dict(type='LoadImageFromFourFile'),
